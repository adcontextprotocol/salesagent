...
## [2.1.0](https://github.com/prebid/salesagent/compare/v2.0.0...v2.1.0) (2026-09-09)
...
* route all outbound HTTP through one SSRF-guarded seam ([#1802](https://github.com/prebid/salesagent/issues/1802)) ([f9e82da](https://github.com/prebid/salesagent/commit/f9e82da6a250d9e89237634e218eeb671e57ed0d))
* **skills:** ticket-start and prime for per-ticket worktree setup and session orientation ([#1787](https://github.com/prebid/salesagent/issues/1787)) ([fd90b69](https://github.com/prebid/salesagent/commit/fd90b69a802c383cb240ec889d97d35a032d3997))
...
* address [#1508](https://github.com/prebid/salesagent/issues/1508) CodeQL round — sanitize CR/LF in blob-drop log attribution ([ccb980b](https://github.com/prebid/salesagent/commit/ccb980bc756d9ca052574fbbb08edccb46fbd58a))
* address [#1508](https://github.com/prebid/salesagent/issues/1508) review round 2 — all-wire coercion, no-quiet-failures, assets ([f904ef4](https://github.com/prebid/salesagent/commit/f904ef47b7eb9f1a33d3c6f330e01f59ba0ce490))
* address [#1508](https://github.com/prebid/salesagent/issues/1508) review round 3 — attribution oracle + doc accuracy ([5cc0497](https://github.com/prebid/salesagent/commit/5cc0497d63fa996c3e3d45b076bd836ddfe27ee3))
* address [#1508](https://github.com/prebid/salesagent/issues/1508) review round 4 — dedup blob-drop emitter + seed helper ([eb2baa4](https://github.com/prebid/salesagent/commit/eb2baa49dcb9d9304c94ec69ca659cfd03bd0c08))
...
* bound the approval thread's lifetime so a caller can cancel or join it ([#2159](https://github.com/prebid/salesagent/issues/2159)) ([da3b9cd](https://github.com/prebid/salesagent/commit/da3b9cd9f84952da8b38cf2f05399eedad8a612b))
...
* coerce malformed tags blob in list_creatives (untyped-blob crash) ([#1508](https://github.com/prebid/salesagent/issues/1508)) ([eccc45a](https://github.com/prebid/salesagent/commit/eccc45a7669adf04531878b8d88e6330be3a90f6))
* coerce malformed tags blob in list_creatives (untyped-blob crash) ([#1508](https://github.com/prebid/salesagent/issues/1508)) ([c19f1dd](https://github.com/prebid/salesagent/commit/c19f1dd4e5a55259cdd15f379d8d2db235835ebf))
...
* pin AdCP schema validation to the installed SDK and fix the wire-serialization bugs it surfaced ([#1868](https://github.com/prebid/salesagent/issues/1868)) ([61611c3](https://github.com/prebid/salesagent/commit/61611c317b9b75f6161cff79ccb903b92728a3b0))
* run the unit suite under xdist — an unserializable report was silently truncating the session ([#2091](https://github.com/prebid/salesagent/issues/2091)) ([9df6dff](https://github.com/prebid/salesagent/commit/9df6dff905095cf0242e42b34c5c3302d2d276e8))
* **security:** SSRF-validate protocol push and reporting webhook URLs ([#1697](https://github.com/prebid/salesagent/issues/1697)) ([d912a7e](https://github.com/prebid/salesagent/commit/d912a7ee9a1f56ac7c213035bdffee678af56425))
...
* document the architecture, state the engineering standards, and reorganize the docs tree ([#2177](https://github.com/prebid/salesagent/issues/2177)) ([6c378a6](https://github.com/prebid/salesagent/commit/6c378a6763d4fbf21451607ee7af0457cbf5fdbd))
...
* remove developer-specific file paths ([#2228](https://github.com/prebid/salesagent/issues/2228)) ([9984648](https://github.com/prebid/salesagent/commit/99846481909ffbb51452a24e82710c51968f382c))
