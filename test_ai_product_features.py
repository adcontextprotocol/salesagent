...
from ai_product_service import AIProductConfigurationService, ProductDescription, AdServerInventory
...
class TestAIProductService:
    ...
    async def test_create_product_from_description(self, mock_genai):
        ...
        with patch.dict('os.environ', {'GEMINI_API_KEY': 'test_key'}):
            ...
            with patch('ai_product_service.get_db_connection') as mock_db:
                mock_conn = Mock()
                mock_cursor = Mock()
        ...
        with patch.dict('os.environ', {'GEMINI_API_KEY': 'test_key'}):
            with patch('ai_product_service.genai'):
                ...
                premium_desc = ProductDescription(
                    ...
                    external_description="Premium homepage takeover placement"
                )
    ...
    def test_quick_create_products_api(self, client, auth_session):
        ...
        with patch('admin_ui.get_default_products') as mock_products:
            ...
            with patch('admin_ui.get_db_connection') as mock_db:
                ...
                response = client.post(
                    '/api/tenant/test_tenant/products/quick-create',
                    json={'product_ids': ['run_of_site_display']}
                )
...
def test_ai_integration():
    ...
    async def run_test():
        ...
        description = ProductDescription(
            ...
            external_description="Premium banner placement on homepage above the fold"
        )
