...
class GAMSimpleDisplayTest:
    ...
    async def validate_configuration(self) -> bool:
        ...
        try:
            ...
            required_fields = ["network_code", "service_account_key_file", "company_id", "trafficker_id"]
            ...
            if not impl_config.get("creative_placeholders"):
                self.log_test(
                    ...
                    False,
                    "No creative placeholders defined"
                )
                return False
