...
def demo_product_features():
    ...
    for product in default_products:
        pricing = f"${product['cpm']} CPM" if product['cpm'] else f"${product['price_guidance']['min']}-${product['price_guidance']['max']} CPM"
    ...
    for industry in ['news', 'sports', 'entertainment', 'ecommerce']:
        ...
        for product in industry_specific:
            pricing = f"${product['cpm']} CPM" if product.get('cpm') else f"${product['price_guidance']['min']}-${product['price_guidance']['max']} CPM"
