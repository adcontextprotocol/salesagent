        ...
        modifications={
            ...
            "restrictions": {
                "animation": {
                    ...
                    "user_initiated_expansion": False
                }
            }
        }
    )
...
def create_yahoo_extensions(manager: FoundationalFormatsManager):
    ...
    e2e_lighthouse = manager.create_extension(
        ...
        modifications={
            ...
            "additional_specs": {
                ...
                "video_carousel_specs": {
                    "video_dimensions": "720x405 or 1920x1080",
                    "carousel_dimensions": "720x875"
                }
            },
            "enhancements": {
                "mobile_only": True,
    ...
    video_format = manager.create_extension(
        ...
        modifications={
            ...
            "enhancements": {
                "ssl_compliance_required": True,
                "ad_policy_compliance": "Yahoo Ad Policies"
            }
        }
    )
...
def demonstrate_compatibility_check(manager: FoundationalFormatsManager):
    ...
    errors = manager.validate_extension(
        ...
        modifications={
            "restrictions": {
                "file_types": None  # Can't remove required spec
            }
        }
    )
    ...
    test_specs = [
        {
            ...
            "specs": {"product_count": 5, "carousel": True}
        },
        {
            "name": "Expandable banner",
            "specs": {"expandable": True, "collapsed_state": {"width": 728, "height": 90}}
        },
        {
            "name": "Mobile scroll experience",
            "specs": {"scroll": True, "mobile_first": True, "parallax": True}
        },
        {
            "name": "Standard video",
            "specs": {"type": "video", "duration": 30}
        }
    ]
