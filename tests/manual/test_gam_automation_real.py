...
class GAMAutomationTester:
    ...
    def test_automatic_activation(self) -> dict[str, Any]:
        ...
        request = CreateMediaBuyRequest(
            brand_manifest="Athletic footwear and sports equipment",
            po_number="AUTO001",
            total_budget=10.00,
    ...
    def test_confirmation_required(self) -> dict[str, Any]:
        ...
        request = CreateMediaBuyRequest(
            brand_manifest="Consumer electronics and smart home devices",
            po_number="CONF001",
            total_budget=5.00,
    ...
    def test_manual_mode(self) -> dict[str, Any]:
        ...
        request = CreateMediaBuyRequest(
            brand_manifest="Outdoor gear and camping equipment",
            po_number="MAN001",
            total_budget=7.50,
            targeting_overlay=Targeting(),
        )
    ...
    def test_guaranteed_ignores_automation(self) -> dict[str, Any]:
        ...
        request = CreateMediaBuyRequest(
            brand_manifest="Luxury automotive vehicles and accessories",
            po_number="GUAR001",
            total_budget=500.00,
            targeting_overlay=Targeting(),
        )
    ...
    def test_lifecycle_activate_order(self) -> dict[str, Any]:
        ...
        request = CreateMediaBuyRequest(
            brand_manifest="Fitness trackers and wearable technology",
    ...
    def test_lifecycle_submit_for_approval(self) -> dict[str, Any]:
        ...
        request = CreateMediaBuyRequest(
            brand_manifest="Sustainable fashion and eco-friendly clothing",
    ...
    def test_lifecycle_activation_blocking(self) -> dict[str, Any]:
        ...
        request = CreateMediaBuyRequest(
            brand_manifest="Premium pet food and pet care products",
    ...
    def test_lifecycle_archive_order(self) -> dict[str, Any]:
        ...
        request = CreateMediaBuyRequest(
            brand_manifest="Coffee beans and specialty beverages",
