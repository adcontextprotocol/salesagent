...
class TestAdCPSchemaCompliance:
    ...
    async def test_get_products_compliance(
        ...
        valid_requests = [
            {"brand_manifest": "eco-friendly products"},  # Minimal valid request (brand_manifest required)
            {"brief": "display advertising", "brand_manifest": "eco-friendly products"},
            {"brief": "video ads", "brand_manifest": "premium video"},
