...
# IMPORTANT: DO NOT import conftest_db fixtures here!
...
# Unit tests that need database fixtures should skip (they're integration tests anyway).
# from tests.conftest_db import db_session  # ← NEVER UNCOMMENT THIS
