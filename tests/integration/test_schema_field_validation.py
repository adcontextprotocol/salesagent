...
class TestSchemaFieldValidation:
    ...
    def test_tenant_field_references(self):
        ...
        assert not used_deprecated, (
            ...
            f"Use individual columns instead: max_daily_budget, enable_aee_signals, etc."
        )
    ...
    def test_template_field_references(self):
        ...
        problematic_patterns = [
            (r"tenant\.features_config", "Use tenant.max_daily_budget, tenant.enable_aee_signals instead"),
            (
