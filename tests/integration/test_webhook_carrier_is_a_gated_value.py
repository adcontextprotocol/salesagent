...
UNSIGNED_WEBHOOK = ReportingWebhookRequestFactory.payload(
    url="https://buyer.example.com/webhook", authentication=OMIT
)
...
EMPTY_AUTH_WEBHOOK = ReportingWebhookRequestFactory.payload(
    url="https://buyer.example.com/webhook", authentication={}
)
