...
mock_response = {
    ...
    "order": {
        ...
        "totalBudget": {
            "currencyCode": "USD",
            "microAmount": 50000000000  # $50,000
        }
    },
    "creatives": [
        {
...
print(f"Returns: Complete line item data with order, creatives, and media product JSON")
print("\n" + "=" * 80)
print("FULL RESPONSE:")
print("=" * 80)
