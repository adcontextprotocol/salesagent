...
===========================================  ==========================================
predecessor obligation                        graded here as
===========================================  ==========================================
active key + unpublishable origin -> no       ``request_signer_for_tenant`` -> ``None``
signing
same key + publishable origin -> a real       the returned callback signs with that
``SigningConfig`` carrying ``kid``/``alg``    ``kid``/``alg`` under the request-signing
                                              tag
===========================================  ==========================================
...
def signing_env(monkeypatch: pytest.MonkeyPatch) -> Iterator[BareIntegrationEnv]:
    from src.core.signing import clear_signing_provider_cache
