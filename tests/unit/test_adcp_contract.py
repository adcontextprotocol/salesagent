...
class TestAdCPContract:
    ...
    def test_adcp_create_media_buy_request(self):
        ...
        request = CreateMediaBuyRequest(
            ...
            total_budget=5000.0,
            flight_start_date=start_date.date(),
            flight_end_date=end_date.date(),
            targeting_overlay={
    ...
    def test_adcp_signal_support(self):
        ...
        request = CreateMediaBuyRequest(
            ...
            total_budget=1000.0,
            flight_start_date=datetime.now().date(),
            flight_end_date=(datetime.now() + timedelta(days=7)).date(),
            targeting_overlay={
                "signals": [
                    "sports_enthusiasts",
