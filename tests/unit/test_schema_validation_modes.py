...
class TestSchemaValidationModes:
    ...
    def test_development_mode_rejects_extra_fields(self):
        ...
        with patch.dict(os.environ, {}, clear=False):
            ...
            with pytest.raises(ValidationError) as exc_info:
                GetProductsRequest(brief="test", brand_manifest={"name": "Test Brand"}, unknown_field="should_fail")
    ...
    def test_production_mode_ignores_extra_fields(self):
        ...
        with patch.dict(os.environ, {"ENVIRONMENT": "production"}):
            ...
            request = GetProductsRequest(brief="test", brand_manifest={"name": "Test Brand"}, unknown_field="should_be_ignored")
    ...
    def test_environment_case_insensitive(self):
        ...
        # Test uppercase
        with patch.dict(os.environ, {"ENVIRONMENT": "PRODUCTION"}):
            request = GetProductsRequest(brief="test", brand_manifest={"name": "Test Brand"}, extra="ignored")
            assert request.brief == "test"
