...
class TestGeneratedGetProductsRequest:
    ...
    def test_optional_fields_work(self):
        ...
        # With just brand_manifest
        req1 = GeneratedGetProductsRequest(brand_manifest="https://example.com")
        assert req1.brief == ""  # Default value

        # With filters
        req2 = GeneratedGetProductsRequest(
            brand_manifest="https://example.com", filters={"format_ids": ["display_300x250"]}
        )
    ...
    def test_serialization_works(self):
        ...
        data = req.model_dump()
        assert data["brand_manifest"] == "https://example.com"
...
class TestGeneratedGetProductsResponse:
    ...
    def test_can_create_with_products(self):
        ...
        assert len(resp.product_id) == 1
        assert resp.product_id[0]["product_id"] == "prod_123"
    ...
    def test_serialization_roundtrip(self):
        ...
        # Verify
        assert reconstructed.product_id[0]["product_id"] == "prod_456"
        assert reconstructed.product_id[0]["name"] == "Video Pre-Roll"
...
class TestGeneratedSchemasVsManual:
    ...
    def test_generated_and_manual_accept_same_data(self):
        ...
        assert manual.brand_manifest == generated.brand_manifest
...
class TestGeneratedSchemaBenefits:
    ...
    def test_generated_schemas_always_match_spec(self):
        ...
        req = GeneratedGetProductsRequest(brand_manifest="https://example.com")
        assert req.brand_manifest == "https://example.com"
    ...
    def test_no_custom_validators_needed_in_tests(self):
        ...
        req = GeneratedGetProductsRequest(
            brand_manifest="https://example.com", brief="Test", filters={"format_ids": ["display_300x250"]}
        )
        ...
        assert req2.brand_manifest == req.brand_manifest
