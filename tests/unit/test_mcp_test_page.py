    ...
    def test_mcp_test_page_template_rendering(self, auth_client):
        ...
        with patch('admin_ui.get_db_connection') as mock_db:
            ...
            mock_cursor.fetchall.return_value = [
                ('tenant1', 'Tenant One', 'principal1', 'Principal One', 'token123')
            ]
        ...
        with patch('admin_ui.get_db_connection') as mock_db:
            ...
            def mock_run_until_complete(coro):
                ...
                return {
                    'success': True,
                    'result': {
                        'products': [{'product_id': 'test', 'name': 'Test Product'}]
                    }
                }
            ...
            try:
                response = auth_client.post('/api/mcp-test/call',
                    json={
        ...
        with patch('admin_ui.get_db_connection') as mock_db:
            ...
            def mock_run_until_complete(coro):
                return {
                    ...
                    'result': {
                        'products': [
                            {'product_id': 'prod_001', 'name': 'Test Product'}
                        ]
                    }
                }
