...
EXPECTED_LEDGER: frozenset[str] = frozenset(
    {
        ...
        # The 3 uc018 rows that used to sit here GRADUATED 2026-08-31 on main
        # (f9e82da6a): their Givens seed through the factories into the live
        # server's own database, so the block's "injected cross-principal
        # creatives" clause no longer described them. XPASS in innet_270826_0338,
        # innet_270826_1824 and innet_310826_1248 — full evidence in the ledger
        # file's block comment. Never re-add them: this ledger only shrinks.
