...
class TestCustomTargetingTranslation:
    ...
    def test_translate_custom_targeting_multiple_values(self):
        ...
        input_node = {
            "keyId": 14095946,
            "operator": "IS",
            "valueIds": [448946107548, 448946356517]
        }
