...
class Product(Base, JSONValidatorMixin):
    ...
    min_spend = Column(DECIMAL(10, 2))  # AdCP spec field
    measurement = Column(JSON)  # JSONB in PostgreSQL - AdCP measurement object
    creative_policy = Column(JSON)  # JSONB in PostgreSQL - AdCP creative policy object
