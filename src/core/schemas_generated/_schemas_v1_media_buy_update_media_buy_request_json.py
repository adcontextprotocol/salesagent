...
class UpdateMediaBuyRequest1(BaseModel):
    ...
    packages: Annotated[list[Packages | Packages3] | None, Field(description="Package-specific updates")] = (
        None
    )
...
class UpdateMediaBuyRequest2(BaseModel):
    ...
    packages: Annotated[list[Packages4 | Packages5] | None, Field(description="Package-specific updates")] = (
        None
    )
    push_notification_config: Annotated[
