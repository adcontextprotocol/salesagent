...
class Package(BaseModel):
    ...
    formats_to_provide: Annotated[
        list[str] | None, Field(description="Format IDs that creative assets will be provided for this package")
    ] = None
    status: Annotated[Status3, Field(description="Status of a package", title="Package Status")]
