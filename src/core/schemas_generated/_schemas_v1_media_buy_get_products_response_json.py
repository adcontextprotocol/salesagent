...
class PriceGuidance7(BaseModel):
...
class PricingOptions21(BaseModel):
    ...
    price_guidance: Annotated[PriceGuidance7, Field(description="Statistical guidance for auction pricing")]
    min_spend_per_package: Annotated[
        float | None,
        Field(
            description="Minimum spend requirement per package using this pricing option, in the specified currency",
...
class Products(BaseModel):
    ...
    pricing_options: Annotated[
        list[
            PricingOptions | PricingOptions19 | PricingOptions20 | PricingOptions21 | PricingOptions22 | PricingOptions23 | PricingOptions24 | PricingOptions25 | PricingOptions26
        ],
...
class PriceGuidance8(BaseModel):
    floor: Annotated[
        float, Field(description="Minimum bid price - publisher will reject bids under this value", ge=0.0)
    ]
    p25: Annotated[float | None, Field(description="25th percentile winning price", ge=0.0)] = None
...
class PricingOptions28(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    pricing_option_id: Annotated[
    ...
    price_guidance: Annotated[PriceGuidance8, Field(description="Pricing guidance for auction-based CPM bidding")]
    min_spend_per_package: Annotated[
        float | None,
        Field(
            description="Minimum spend requirement per package using this pricing option, in the specified currency",
...
class PricingOptions29(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    pricing_option_id: Annotated[
...
class PriceGuidance9(BaseModel):
    floor: Annotated[float, Field(description="Minimum acceptable bid price", ge=0.0)]
    p25: Annotated[float | None, Field(description="25th percentile of recent winning bids", ge=0.0)] = None
    p50: Annotated[float | None, Field(description="Median of recent winning bids", ge=0.0)] = None
    p75: Annotated[float | None, Field(description="75th percentile of recent winning bids", ge=0.0)] = None
...
class PricingOptions30(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    pricing_option_id: Annotated[
    ...
    price_guidance: Annotated[PriceGuidance9, Field(description="Statistical guidance for auction pricing")]
    min_spend_per_package: Annotated[
        float | None,
        Field(
            description="Minimum spend requirement per package using this pricing option, in the specified currency",
...
class PricingOptions31(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    pricing_option_id: Annotated[
...
class PricingOptions32(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    pricing_option_id: Annotated[
...
class PricingOptions33(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    pricing_option_id: Annotated[
...
class PricingOptions34(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    pricing_option_id: Annotated[
...
class PricingOptions35(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    pricing_option_id: Annotated[
...
class Products1(BaseModel):
    ...
    pricing_options: Annotated[
        list[
            PricingOptions27 | PricingOptions28 | PricingOptions29 | PricingOptions30 | PricingOptions31 | PricingOptions32 | PricingOptions33 | PricingOptions34 | PricingOptions35
        ],
        Field(description="Available pricing models for this product", min_length=1),
    ]
    estimated_exposures: Annotated[
