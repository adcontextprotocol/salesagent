...
class Creative(BaseModel):
    ...
    snippet: Annotated[
        str | None, Field(description="Third-party tag, VAST XML, or code snippet (for third-party assets)")
    ] = None
...
class ListCreativesResponse(BaseModel):
    ...
    context_id: Annotated[str | None, Field(description="Context ID for tracking related operations")] = None
