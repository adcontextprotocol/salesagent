    ...
    try:
        with get_db_session() as db_session:
            ...
            for product in products:
                ...
                logger.info(f"[DEBUG] Product {product.product_id} raw product.format_ids from DB: {product.formats}")
    ...
    try:
        with get_db_session() as db_session:
            ...
            if request.method == "POST":
                ...
                logger.info(f"[DEBUG] product.format_ids = {product.formats}")
                ...
                logger.info(f"[DEBUG] After commit - product.format_ids from DB: {product.formats}")
