...
class ContextManager(DatabaseManager):
    ...
    def create_workflow_step(
        ...
        object_mappings: Optional[List[Dict[str, str]]] = None,
    ...
    def get_object_lifecycle(
        ...
        try:
            ...
            mappings = session.query(ObjectWorkflowMapping).filter_by(
                ...
                object_id=object_id
            ).order_by(ObjectWorkflowMapping.created_at).all()
    ...
    def get_contexts_for_principal(
        self,
        tenant_id: str,
        principal_id: str,
        limit: int = 10
        ...
        try:
            contexts = session.query(Context).filter_by(
                tenant_id=tenant_id,
                principal_id=principal_id
            ).order_by(Context.last_activity_at.desc()).limit(limit).all()
