...
from adapters.gam_error_handling import (
    GAMError, GAMAuthenticationError, GAMPermissionError,
    GAMConfigurationError, with_retry
)
        ...
        try:
            ...
            if not inaccessible_units:
                ...
                return HealthCheckResult(
                    ...
                    details={
                        "accessible": accessible_units,
                        "inaccessible": inaccessible_units
                    },
                    duration_ms=(time.time() - start_time) * 1000
                )
            else:
    ...
    def get_status_summary(self) -> Dict[str, Any]:
        ...
        if not self.last_results:
            return {
                ...
                "message": "No health check has been run",
                "last_check": None
            }
