...
class TargetingCapabilities(BaseModel):
    ...
    aee_dimensions: List[TargetingDimension] = Field(
        description="Dimensions provided to AEE for decisioning"
    )
...
COMMON_OVERLAY_DIMENSIONS = [
    ...
    TargetingDimension(
        key="metro",
        display_name="Metro/DMA",
        description="Metro area or DMA code",
        data_type="array"
    ),
    TargetingDimension(
        key="city",
    ...
    TargetingDimension(
        ...
        description="Available user identity providers",
        data_type="object"
    )
]
...
CTV_SPECIFIC_AEE = [
    ...
    TargetingDimension(
        key="iris_id",
        display_name="IRIS.TV ID",
        description="IRIS.TV content identifier",
        data_type="string"
    ),
    TargetingDimension(
        key="gracenote_id",
        display_name="Gracenote ID",
        description="Gracenote content identifier",
        data_type="string"
    )
]
...
WEB_SPECIFIC_OVERLAY = [
    ...
    TargetingDimension(
        ...
        description="Page keywords for contextual targeting",
        data_type="array"
    )
]
...
WEB_SPECIFIC_AEE = [
    ...
    TargetingDimension(
        key="referrer_url",
        display_name="Referrer URL",
        description="Referring page URL",
        data_type="string"
    ),
    TargetingDimension(
        key="ad_slot_id",
        display_name="Ad Slot ID",
        description="Specific ad slot identifier",
        data_type="string"
    ),
    TargetingDimension(
        key="gpid",
...
MOBILE_APP_SPECIFIC_AEE = [
    ...
    TargetingDimension(
        ...
        description="Current screen or view name",
        data_type="string"
    )
]
...
DOOH_SPECIFIC_OVERLAY = [
    ...
    TargetingDimension(
        ...
        description="Physical screen dimensions",
        data_type="array"
    )
]
...
DOOH_SPECIFIC_AEE = [
    ...
    TargetingDimension(
        ...
        description="Estimated foot traffic data",
        data_type="object"
    )
]
...
CHANNEL_CAPABILITIES: Dict[Channel, TargetingCapabilities] = {
    Channel.AUDIO: TargetingCapabilities(
        ...
        aee_dimensions=COMMON_OVERLAY_DIMENSIONS + AUDIO_SPECIFIC_OVERLAY + 
                       COMMON_AEE_DIMENSIONS + AUDIO_SPECIFIC_AEE
    ),
    Channel.WEB: TargetingCapabilities(
        channel=Channel.WEB,
        overlay_dimensions=COMMON_OVERLAY_DIMENSIONS + WEB_SPECIFIC_OVERLAY,
        aee_dimensions=COMMON_OVERLAY_DIMENSIONS + WEB_SPECIFIC_OVERLAY + 
                       COMMON_AEE_DIMENSIONS + WEB_SPECIFIC_AEE
    ),
    Channel.MOBILE_APP: TargetingCapabilities(
        ...
        aee_dimensions=COMMON_OVERLAY_DIMENSIONS + MOBILE_APP_SPECIFIC_OVERLAY + 
                       COMMON_AEE_DIMENSIONS + MOBILE_APP_SPECIFIC_AEE
    ),
    Channel.CTV: TargetingCapabilities(
        channel=Channel.CTV,
        overlay_dimensions=COMMON_OVERLAY_DIMENSIONS + CTV_SPECIFIC_OVERLAY,
        aee_dimensions=COMMON_OVERLAY_DIMENSIONS + CTV_SPECIFIC_OVERLAY + 
                       COMMON_AEE_DIMENSIONS + CTV_SPECIFIC_AEE
    ),
    Channel.DOOH: TargetingCapabilities(
        channel=Channel.DOOH,
        overlay_dimensions=COMMON_OVERLAY_DIMENSIONS + DOOH_SPECIFIC_OVERLAY,
        aee_dimensions=COMMON_OVERLAY_DIMENSIONS + DOOH_SPECIFIC_OVERLAY + 
                       COMMON_AEE_DIMENSIONS + DOOH_SPECIFIC_AEE
    )
}
